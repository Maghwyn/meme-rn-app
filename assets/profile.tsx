...
const ProfileSvg = ({ size = 48, fill = "#26e07f", stroke = "#FFF", ...props }) => (
    <Svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
